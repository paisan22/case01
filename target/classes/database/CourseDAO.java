...
public class CourseDAO extends DAO<Course> {
    ...
    public List<Course> getAll() throws SQLException, ClassNotFoundException {
        ...
        while (resultSet.next()) {
            ...
            LocalDate localDate = resultSet.getDate("start_date").toLocalDate();
            LocalDate localDate1 = LocalDate.parse(localDate.toString(), DateTimeFormatter.BASIC_ISO_DATE);
            
            course.setStartDate(localDate1);
